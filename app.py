...
<style>
  ...
  /* hide Streamlit rainbow top bar & viewer badge */
  [data-testid="stDecoration"],
  [data-testid="stAppViewBlockContainer"] > div:first-child [data-testid="stDecoration"],
...
"""
  ...
  <div class="overlay">
    <div class="topbar">
      <div class="brand">
        <div class="brand-mark"><svg width="32" height="32" viewBox="24 30 300 300" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="app-ic-a" x1="32" y1="40" x2="260" y2="300" gradientUnits="userSpaceOnUse"><stop stop-color="#FFC14D"/><stop offset="1" stop-color="#FF9F1A"/></linearGradient><linearGradient id="app-ic-d" x1="0" y1="0" x2="320" y2="320" gradientUnits="userSpaceOnUse"><stop stop-color="#121A26"/><stop offset="1" stop-color="#0A1018"/></linearGradient></defs><rect x="24" y="30" width="300" height="300" rx="72" fill="url(#app-ic-d)"/><path d="M112 246L176 88H228L292 246H239L224 207H180L166 246H112ZM194 163H210L202 140L194 163Z" fill="url(#app-ic-a)"/><path d="M94 212C120 167 163 136 219 120C243 113 267 110 291 110" stroke="#5CD2FF" stroke-width="10" stroke-linecap="round" stroke-dasharray="2 18"/><path d="M274 98L309 111L283 139" stroke="#5CD2FF" stroke-width="10" stroke-linecap="round" stroke-linejoin="round"/></svg></div>
